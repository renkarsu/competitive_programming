...
/* func */
//GCD(a, b)==GCD(b, a%b)らしいので調べる
//ABC131Cでバグった.人によってはこれでも通るけど
//constexpr int GCD(int a, int b){return b ? GCD(b, a%b) : a;}
//constexpr int LCM(int a, int b){return a / GCD(a, b) * b;}

// auto mlcm=[](int p,int q){return p/__gcd(p,q)*q;};をmain関数内で使う
//globalにすると#define int long longの恩恵が得られないし,何故かオーバーフローにもならない
//defineを上の方に書けばグローバルにできる.コードジェネレータやconstexprとdefineがバトる
...
constexpr long long LINF = 1001001001001001001ll;//Don't use int64_t
